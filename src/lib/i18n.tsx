...
const ru: Record<string, string> = {
  ...
  "signals": "сигналов",
  "independent signals": "независимых сигналов",
  "sources": "источников",
  "Join the conversation and explain the existing solution.": "Присоединитесь к обсуждению и объясните существующее решение.",
  "Review whether this roadmap item deserves higher priority.": "Проверьте, нужно ли повысить приоритет этого пункта плана.",
  "Investigate this repeated unmet need as a new product opportunity.": "Изучите повторяющуюся неудовлетворённую потребность как новую продуктовую возможность.",
  "Public web": "Публичный интернет",
  "Engagement unavailable": "Данные о вовлечённости недоступны",
  "Grouped by the deterministic evidence processor.": "Сгруппировано детерминированным обработчиком свидетельств.",
  "Unknown": "Неизвестно",
